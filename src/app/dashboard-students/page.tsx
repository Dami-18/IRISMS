  ...
  return (
    <>
        ...
        <table className="w-full border-collapse border border-gray-300">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                <button className="font-semibold bg-green-600">Accepted</button>
              </td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-2">
              ...
              <td className="border border-gray-300 p-2">
                <button className="font-semibold bg-red-600">Rejected</button>
              </td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-2">ML Internship</td>
              <td className="border border-gray-300 p-2">
                <button className="font-semibold bg-yellow-600">
                  In review
                </button>
              </td>
            </tr>
      ...
      <div className="mt-15 flex justify-center items-center">
        <Link
          href="/internships"
          className="font-semibold bg-blue-400 px-4 py-2 rounded"
        >
          Explore Internships
        </Link>
      </div>
